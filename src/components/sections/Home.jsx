        ...
        >
            <div className="text-center z-10 px-4">
                ...
                <div className="flex justify-center space-x-10">
                    <a href="https://github.com/guillaumerbs" target="_blank" rel="noopener noreferrer" className="text-gray-300 text-4xl hover:text-green-700">
                        <FaGithub />
                    </a>
                    <a href="https://www.linkedin.com/in/guillaumeribas" target="_blank" rel="noopener noreferrer" className="text-gray-300 text-4xl hover:text-blue-500">
                        <FaLinkedin />
                    </a>
                    <a href="/cv.pdf" download className="text-gray-300 text-4xl hover:text-red-600">
                        <FaFileDownload />
                    </a>
                </div>
            </div>
